...
-Ensure that the optimized problem accurately reflects the original problem intent and does not alter the original intention.`,
    ...
    humanInTheLoopNode: {
      ...
      text: 'Pause the workflow and wait for a user confirmation or text input before continuing',
      reject: 'Reject',
      action: 'Action',
      confirmed: 'Confirmed',
      ...
      actions: {
        label: 'Actions',
        labelRequired: 'Please enter an action label',
        actionLabel: 'Action Label',
        valueRequired: 'Please enter an action value',
        actionValue: 'Action Value',
        branchId: 'Branch ID',
        requiredMessage: 'Please add at least one action',
      },
    },
    rerankerNode: {
